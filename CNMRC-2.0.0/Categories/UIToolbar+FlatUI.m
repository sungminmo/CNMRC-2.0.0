...
//    [previousButton setImage:[UIImage imageNamed:@"bottom_icon_pre@2x.png"] forState:UIControlStateNormal];
...
//    [greenButton setImage:[UIImage imageNamed:@"bottom_icon_green@2x.png"] forState:UIControlStateNormal];
...
//    [circleMenuButton setBackgroundImage:[UIImage imageNamed:@"rcmenu_btn_normal@2x.png"] forState:UIControlStateNormal];
...
//    [yellowButton setImage:[UIImage imageNamed:@"bottom_icon_yellow@2x.png"] forState:UIControlStateNormal];
...
//    [outButton setImage:[UIImage imageNamed:@"bottom_icon_out@2x.png"] forState:UIControlStateNormal];
...
//{
//    [AppDelegate.container toolbarAction:sender];
//}
//
//// 툴바 열기.
//- (void)openToolbar
